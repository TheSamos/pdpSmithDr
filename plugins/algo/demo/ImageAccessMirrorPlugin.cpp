...
const sd::frontend::AlgorithmInfo ImageAccessMirrorPlugin<T>::m_input = 
		   sd::frontend::make_info(sd::core::ObjectDescription::ImageView(sd::core::DataType_<T>(),
										  ...
										  sd::core::ObjectDescription::ANY_CARD));
template<typename T>
const sd::frontend::ParameterList ImageAccessMirrorPlugin<T>::m_parameters = 
		   sd::frontend::make_parameter_list("horizontal", false);
...
void
registerPlugin() {
  sd::frontend::registerAlgorithm(new ImageAccessMirrorPlugin<sd::UINT8>);
  sd::frontend::registerAlgorithm(new ImageAccessMirrorPlugin<sd::INT8>);
  sd::frontend::registerAlgorithm(new ImageAccessMirrorPlugin<sd::UINT16>);
  sd::frontend::registerAlgorithm(new ImageAccessMirrorPlugin<sd::INT16>);
  sd::frontend::registerAlgorithm(new ImageAccessMirrorPlugin<float>);
  sd::frontend::registerAlgorithm(new ImageAccessMirrorPlugin<double>);
}
