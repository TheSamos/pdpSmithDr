...
public:
  ...
  ImageMirrorPlugin() : sd::frontend::ComputedImageViewAlgorithm<T>(m_name, m_input),
			m_horizontal(false) {}
...
registerPlugin() {
  ...
  sd::frontend::registerAlgorithm(new ImageMirrorPlugin<sd::UINT8>, parameters);
  sd::frontend::registerAlgorithm(new ImageMirrorPlugin<sd::INT8>, parameters);
  sd::frontend::registerAlgorithm(new ImageMirrorPlugin<sd::UINT16>, parameters);
  sd::frontend::registerAlgorithm(new ImageMirrorPlugin<sd::INT16>, parameters);
  sd::frontend::registerAlgorithm(new ImageMirrorPlugin<float>, parameters);
  sd::frontend::registerAlgorithm(new ImageMirrorPlugin<double>, parameters);
}
