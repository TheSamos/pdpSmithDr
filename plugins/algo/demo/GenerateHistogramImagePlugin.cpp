...
registerPlugin()
{
    ...
    parameters.push_back(sd::frontend::Parameter("nbTiles", 256, 1, 256));

    const std::vector<std::string> channels = { "Red", "Green", "Blue", "Alpha"};
    sd::frontend::Parameter channel("channel", channels[0], channels);
