...
template<typename T>
class SaverPgm3dPlugin : public sd::frontend::Saver
{
...
template<typename T> const std::string SaverPgm3dPlugin<T>::m_name = "SaverPgm3dPlugin";
template<typename T> const sd::frontend::AlgorithmInfo SaverPgm3dPlugin<T>::m_input = sd::frontend::make_info((sd::core::ImageView*) 0);
template<typename T> const sd::frontend::ParameterList SaverPgm3dPlugin<T>::m_parameters = sd::frontend::make_parameter_list("filename", "", "binary", true);
...
registerPlugin()
{
  sd::frontend::registerSaver(new SaverPgm3dPlugin<sd::UINT8>);
  sd::frontend::registerSaver(new SaverPgm3dPlugin<sd::UINT16>);
}
