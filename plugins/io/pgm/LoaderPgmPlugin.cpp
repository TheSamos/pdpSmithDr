...
template<typename T>
class LoaderPgmPlugin : public sd::frontend::Loader
{
...
template<typename T> const std::string LoaderPgmPlugin<T>::m_name = "LoaderPgmPlugin";
template<typename T> const sd::frontend::AlgorithmInfo LoaderPgmPlugin<T>::m_output = sd::frontend::make_info((sd::core::ImageView*) 0);
template<typename T> const sd::frontend::ParameterList LoaderPgmPlugin<T>::m_parameters = sd::frontend::make_parameter_list("filename", "");
...
registerPlugin()
{
  sd::frontend::registerLoader(new LoaderPgmPlugin<sd::UINT8>);
  sd::frontend::registerLoader(new LoaderPgmPlugin<sd::UINT16>);
}
