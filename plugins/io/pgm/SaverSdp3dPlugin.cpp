...
template<typename T>
class SaverSdp3dPlugin : public sd::frontend::Saver
{
...
template<typename T> const std::string SaverSdp3dPlugin<T>::m_name = "SaverSdp3dPlugin";
template<typename T> const sd::frontend::AlgorithmInfo SaverSdp3dPlugin<T>::m_input = sd::frontend::make_info((sd::core::ImageView*) 0);
template<typename T> const sd::frontend::ParameterList SaverSdp3dPlugin<T>::m_parameters = sd::frontend::make_parameter_list("filename", "", "binary", true);
...
registerPlugin()
{
  sd::frontend::registerSaver(new SaverSdp3dPlugin<sd::UINT8>);
  sd::frontend::registerSaver(new SaverSdp3dPlugin<sd::UINT16>);
}
