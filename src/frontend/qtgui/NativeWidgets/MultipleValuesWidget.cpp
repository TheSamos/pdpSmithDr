...
MultipleValuesWidget::MultipleValuesWidget(sd::libqt::SDRParameter* p)
...
void
getVectorParameter(QWidget *w, ValueReader valueReader, sd::libqt::SDRParameter* p)
{
...
sd::libqt::SDRParameter* MultipleValuesWidget::updateXMLParameter()
{
    return m_p;
}
